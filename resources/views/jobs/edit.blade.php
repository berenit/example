    ...
    <form method="POST" action="/jobs/{{ $job->id }}">
                        ...
                        <div class="mt-2">
                            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                <input
                                    ...
                                    id="salary"
                                    class="block flex-1 border-0 bg-transparent py-1.5 px-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                    placeholder="€ 30.000,00 per year."
                                    value="{{ $job->salary }}"
                                >
                            </div>
                            <p class="text-xs test-red-500 font-semibold mt-2 ml-2 text-red-500">
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
            <div class="flex items-center">
                <button form="delete-form" class="text-sm font-semibold text-red-500 border rounded-md px-3 py-2 border-gray-200 hover:border-gray-700 shadow-sm">Cancella</button>
            </div>
            <div class="flex item-center gap-x-6">
                <a href="/jobs/{{ $job->id }}" type="button" class="text-sm font-semibold text-gray-900 border rounded-md px-3 py-2 border-gray-200 hover:border-gray-700 shadow-sm">Annulla</a>
                <div>
